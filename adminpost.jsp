...
<div id="divid">
 ...
 <form method="post" action="adminpost_1.jsp"> 
         <table Id="course-table" width="400px" align="center" border=2>
                <tr><td align="center" colspan="2" bgcolor="#4CAF50"><font color="#FFFFFF"><h2>post tender Requirement Details</h2></font>
          ...
          <tr><td>Mode of Training </td><td><input type="text" name="mot" required></td></tr>
            <tr><td>Batch Type </td><td><input type="text" name="bt" required></td></tr>
            <tr><td> Closing date</td><td><input type="text" name="cd" required></td></tr>
             <tr><td>Note </td><td><textarea name="nots" rows="4" cols="25" required></textarea></td></tr>
