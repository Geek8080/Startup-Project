    ...
    <center>
        ...
        <form action="UploadServlet2" method="post" enctype="multipart/form-data">
             <table Id="course-table" width="400px" align="center" border=2>
                <tr>
                    <td align="center" colspan="2" bgcolor="#4CAF50"><font color="#FFFFFF"><h2>Start Ups/Companies and Job Consultants Form Details</h2></font>
                   
                </tr>
                <tr>
                    <td>Type(Company/Job Consultant)</td>
                    <td>
                ...
                <tr>
                    <td>Founding Year  </td>
                    <td>
                        <input type="text" required="" name="fy">
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <input type="text" required="" name="ido">
                    </td>
                </tr>
