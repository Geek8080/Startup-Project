...
<%
  ...
  try{
      ...
      String query="insert into adminpost(cou,dur,loc,mot,bt,cd,nots,sta)values('"+cou+"',"+dur+",'"+loc+"','"+mot+"','"+bt+"','"+cd+"','"+nots+"','Open')";
...
<table Id="course-table" align="center">
          <div id="course-table">
              <H2> Invalid Input<a href="adminpost.jsp"><br>Try again</a></H2>
          </div>
      </table>
