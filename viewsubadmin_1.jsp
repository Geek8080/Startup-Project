...
<%
  ...
  try{
      ...
      String query="insert into subadmin(Name,passord,email,mobile,city)values('"+name+"','"+passord+"','"+email+"',"+mobile+",'"+city+"')";
...
CoursesEnrolled(studentid,courseid),feepaid
  --%>
    ...
    <center><h1>New Sub Admin Created Successfully</h1></center>
