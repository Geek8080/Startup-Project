    ...
    <center>
       ...
       <table Id="course-table" width="400px" align="center" border=2>
            ...
            %>
             ...
             <tr>
                 <td align="center" colspan="2" bgcolor="#4CAF50"><font color="#FFFFFF"><h2>Start Ups/Companies and Job Consultants<%=rs.getInt("Id")%></h2></font>
             </tr>
             <tr>
                 ...
                 <tr>
                 <td> Name of Company</td><td><%=rs.getString("lastname")%></td>
             </tr>
             <tr>
