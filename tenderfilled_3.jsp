...
<%
  ...
  try{
   ...
   <center>
       ...
       <form method="post" action="tenderfilled_1_4.jsp"> 
         <table Id="course-table" width="400px" align="center" border=2>
          ...
          <tr><td>Name of Institute/Trainer</td><td><input type="text" value="<%=name%>" name="noit" required></td></tr>
          <tr><td> Trainer Name</td><td><input type="text" name="tn" required></td></tr>
           <tr><td>Trainer Profile link</td><td><input type="text" name="tpl" required></td></tr>
       
          <tr><td>Course  </td><td><input type="text" name="cou" required></td></tr>
            <tr><td>Duration </td><td><input type="text" name="dur" required></td></tr>
            <tr><td> Location </td><td><input type="text" name="loc" required></td></tr>
            <tr><td> Mode of Training </td><td><input type="text" name="mot" required></td></tr>
            <tr><td>Fee per student </td><td><input type="text" name="fps" required></td></tr>
      
          <tr><td>Trainer Type</td><td> <select name="tt">
                <option>Individual</option>
                 <option>Institute</option>
           </select></td></tr>
            <tr><td>Trainer Industry Experience </td><td><input type="text" name="tie" required></td></tr>
            <tr><td> Trainer Training Experience</td><td><input type="text" name="tte" required></td></tr>
            <tr><td>Projects Handled </td><td><input type="text" name="ph" required></td></tr>
             <tr><td>Batches Taken</td><td><input type="text" name="bt" required></td></tr>
