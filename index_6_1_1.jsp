...
%>
<tr>
  <td align="center" colspan="2" bgcolor="#4CAF50"><font color="#FFFFFF"><h2>schools and colleges posting requirement<%=rs.getInt("Id")%></h2></font>
</tr>
<tr>
  <td>Name of Institute</td><td><%=rs.getString("noi")%></td>
</tr>
<tr>
  <td>Required Course</td><td><%=rs.getString("rc")%></td>
</tr>
<tr>
  <td>Duration</td><td><%=rs.getString("dur")%></td>
</tr>
<tr>
  <td>Target Fee per Student</td><td><%=rs.getString("tfps")%></td>
</tr>
<tr>
  <td>Location</td><td><%=rs.getString("loc")%></td>
</tr>
<tr>
  <td>Mode of Training (Online/Offline)</td><td><%=rs.getString("mot")%></td>
</tr>
<tr>
      <td>Note</td><td><textarea STYLE=" font-family: Verdana;  font-size: 12px; ;"  NAME="Question" rows="10" cols="27" readonly="1"  placeholder="Messages..."> <%=rs.getString("nots")%>   </textarea></td>
